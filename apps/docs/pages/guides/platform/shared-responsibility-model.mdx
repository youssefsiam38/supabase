...
Supabase offers a lot of opportunities for flexibly integrating with third-party services. This varies from making calls to external APIs from Postgres triggers, to using custom SMTP services for greater control over your outgoing emails. You are free to use and integrate with any service, but you're also responsible for ensuring that the performance and availability of the services you use match up with your application's requirements.
